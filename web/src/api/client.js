...
export const credit = {
  ...
  disputeOptions: () => api('/credit/dispute-options'),
  setLetterhead: (body) => api('/credit/letterhead', { method: 'PUT', body }),
  startDispute: (itemId, body) => api(`/credit/items/${itemId}/dispute`, { method: 'POST', body }),
  cases: () => api('/credit/cases'),
  getCase: (id) => api(`/credit/cases/${id}`),
  recordOutcome: (id, body) => api(`/credit/cases/${id}/outcome`, { method: 'POST', body }),
  nextRound: (id, body) => api(`/credit/cases/${id}/next`, { method: 'POST', body }),
  letterCase: (letterId) => api(`/credit/letters/${letterId}`),
